...
<template>
  <div class="modify-pass">
    ...
    >
      <el-form ref="passform" label-width="80px" :model="form" :rules="rules">
        ...
        <el-form-item label="确认密码" :required="true" prop="renewpass">
          <el-input
        ...
        <el-form-item style="margin-top:-18px;">
          <p style="color:#999;">密码长度8 - 16 位，必须包含大写字母、小写字母和数字</p>
        </el-form-item>
      </el-form>
