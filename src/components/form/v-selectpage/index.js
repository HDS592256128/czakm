...
const Plugin = {
  install(Vue, option = {}){
    if (Object.keys(option).length) {
      ...
      if (typeof option.hideHeaderBar === 'boolean') props.hideHeaderBar.default = option.hideHeaderBar;
      if (typeof option.lastPicked === 'object') props.lastPicked.default = option.lastPicked;
