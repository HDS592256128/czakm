        ...
        buildHeader(h) {
            ...
            const genBtn = (title, btnClass, iconClass, event) => {
                return h('button', {
                    ...
                    h('i', {
                        class: `sp-iconfont ${iconClass}`
                    })
                ]);
            };

            if (this.multiple) {
                header.push(genBtn(this.i18n.select_all, 'sp-select-all-btn', 'sp-icon-select-all', () => {
                    this.pickPage()
                }));
                header.push(genBtn(this.i18n.unselect_all, 'sp-remove-all-btn', 'sp-icon-unselect-all', () => {
                    this.pickPage(false)
                }));
            }
            ...
            if (this.message) {
                return h('transition', {
                    ...
                    h('div', {
                        ...
                        h('i', {
                            class: 'sp-iconfont sp-icon-warning'
                        }),
                        h('span', {
                            domProps: {
